...
const navigation = [
  ...
  { name: 'Create New Post', href: '#', current: false },
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <h3 className="text-1xl font-bold text-white sm:text-cente my-blog">My Blog</h3>
                </div>
              ...
              >
                {({ isSubmitting }) => (
                  <Form className="flex items-center hidden sm:block">
                    <Field
                      type="text"
                      name="query"
                      placeholder="Search..."
                    ...
                    />
                    <ErrorMessage name="query" component="div" className="text-red-600 text-sm ml-2" />
                  </Form>
                )}
              </Formik>
